### Generated logs from GitHub Action: [29236085505](https://github.com/dbuchanaRH/multicluster-observability-operator/actions/runs/29236085505)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260711175913-8ea96d7f8cfa
...
- go: downloading github.com/openshift/api v0.0.0-20260710200753-d8a1748da7dc
...
- go: downloading github.com/openshift/client-go v0.0.0-20260703082747-24d059aea27a
...
- go: downloading github.com/thanos-io/thanos v0.42.0
...
- go: downloading k8s.io/kube-openapi v0.0.0-20260706235625-cdb1db5517a0
...
- go: downloading github.com/openshift/library-go v0.0.0-20260710103416-a0ff75920a1e
...
- go: downloading github.com/zmap/zcrypto v0.0.0-20260713063240-53a3873b1c12
...
- go: downloading github.com/aws/aws-sdk-go-v2/config v1.32.29
- go: downloading github.com/aws/aws-sdk-go-v2/credentials v1.17.68
- go: downloading github.com/aws/aws-sdk-go-v2/credentials v1.19.28
...
- go: downloading google.golang.org/genproto v0.0.0-20260706201446-f0a921348800
...
- go: github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring@v0.92.1 requires go >= 1.26.0; switching to go1.26.5
- go: downloading go1.26.5 (linux/amd64)
- go: all: module cloud.google.com/go/auth@upgrade found (v0.21.0), but does not contain package cloud.google.com/go/auth/internal/trustboundary
...
- go: all: module google.golang.org/grpc@upgrade found (v1.82.0), but does not contain package google.golang.org/grpc/internal/balancer/weight
