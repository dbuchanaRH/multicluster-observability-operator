### Generated logs from GitHub Action: [28854179497](https://github.com/dbuchanaRH/multicluster-observability-operator/actions/runs/28854179497)
...
- go: downloading github.com/prometheus/prometheus v0.313.0
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260706171757-dda605528cb4
...
- go: downloading github.com/openshift/api v0.0.0-20260703175546-02e2c3de12fb
...
- go: downloading github.com/openshift/library-go v0.0.0-20260703081820-c6cd1a243d2d
...
- go: downloading google.golang.org/api v0.287.0
...
- go: all: module github.com/prometheus/prometheus@upgrade found (v0.313.0), but does not contain package github.com/prometheus/prometheus/tsdb/errors
